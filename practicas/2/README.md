# Práctica 2: Ramas paralelas de desarrollo
    ...
    Práctica creada: 2023.08.22
    Entrega en tiempo: 2023.08.29

## ¡Me equivoqué! Va la corrección...

En el [paso 8 (último) de la práctica
anterior](https://github.com/unamfi/sistop-2024-1/tree/main/practicas/1#8-configura-tu-copia-local-para-seguir-al-repositorio-raiz)
...
corregirlo, desde su repositorio, ejecuten:
    ...
    $ git remote set-url prof https://github.com/unamfi/sistop-2024-1
	# git pull prof main
