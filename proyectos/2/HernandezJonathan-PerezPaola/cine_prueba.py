...
# Se inicia el hilo para la deserción aleatoria de espectadores.
desercion_thread = threading.Thread(target=desercion_aleatoria)
desercion_thread.start()

# Esperar a que el hilo de deserción termine antes.
desercion_thread.join()
